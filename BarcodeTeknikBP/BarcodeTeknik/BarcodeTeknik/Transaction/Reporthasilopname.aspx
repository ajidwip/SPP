<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporthasilopname.aspx.cs" Inherits="BarcodeTeknik.Transaction.Reporthasilopname" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div style="margin:0px 100px 0 100px;">
          <div class="row" style="margin-right:-60px;margin-left:-70px">
             <div class="container">
                    <div>
                          <h3 style="text-align:center;font-family:Calibri">Hasil Opname</h3>   
                     </div>
                    ...
                    <thead >
                        <tr>
							...
							<th class="col-md-1 col-sm-2" style="text-align: center;">Part NO</th>
						 	<th class="col-md-1 col-sm-2" style="text-align: center;">UOM</th>
                            <th class="col-md-1 col-sm-1" style="text-align: center;">Contract</th>
                            <th class="col-md-1 col-sm-2" style="text-align: center;">Rak No</th>
							<th class="col-md-1 col-sm-2" style="text-align: center;">Part Description</th>
                            <th class="col-md-1 col-sm-2" style="text-align: center;">Total Fisik</th>
						   <th class="col-md-1 col-sm-2" style="text-align: center;">Total Sistem</th>
                           <th class="col-md-1 col-sm-2" style="text-align: center;">Selisih</th>
                        </tr>
                    </thead>
                    <tbody>
                        <asp:ListView ID="lvBKKDetail" runat="server">
                            ...
                            <ItemTemplate>
                                <tr class="summary">
								 <td><%# Eval("Nomor") %></td>
								    <td><%# Eval("Part_No") %></td>
								 	<td><%# Eval("unit_meas") %></td>
                                    <td><%# Eval("Contract") %></td>
                                    <td><%# Eval("Rak_No") %></td>
									<td><%# Eval("partDesc") %></td>
                                    <td><%# Eval("TotalFisik") %></td>
								<td><%# Eval("TotalSistem") %></td>
								<td><%# Eval("selisih") %></td>
                                </tr>
                            </ItemTemplate>
                        </asp:ListView>
