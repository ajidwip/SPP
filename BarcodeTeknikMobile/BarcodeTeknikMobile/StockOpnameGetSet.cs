...
namespace BarcodeTeknikMobile
{
    ...
    public class StockOpnameGetSet
    {
        ...
        public string RakNo = "";
        public string uom = "";
        public StockOpnameGetSet()
        {

        }
        public StockOpnameGetSet(string mPartNo, string pQty, string pFlag, string pfirstscan, string pContract, string pstatuskirim,string pRakNo,string puom)
        {
            this.PartNo = mPartNo;
            this.Qty = pQty;
            this.flag = pFlag;
