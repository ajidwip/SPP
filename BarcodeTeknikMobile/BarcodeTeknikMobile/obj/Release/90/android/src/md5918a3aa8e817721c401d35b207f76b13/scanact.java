...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BarcodeTeknikMobile.scanact, BarcodeTeknikMobile", scanact.class, __md_methods);
	}
	...
	public scanact ()
	{
		...
		if (getClass () == scanact.class)
			mono.android.TypeManager.Activate ("BarcodeTeknikMobile.scanact, BarcodeTeknikMobile", "", this, new java.lang.Object[] {  });
	}
