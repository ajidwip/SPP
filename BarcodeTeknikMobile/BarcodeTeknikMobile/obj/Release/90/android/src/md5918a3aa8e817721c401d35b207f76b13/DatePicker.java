...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BarcodeTeknikMobile.DatePicker, BarcodeTeknikMobile", DatePicker.class, __md_methods);
	}
	...
	public DatePicker ()
	{
		...
		if (getClass () == DatePicker.class)
			mono.android.TypeManager.Activate ("BarcodeTeknikMobile.DatePicker, BarcodeTeknikMobile", "", this, new java.lang.Object[] {  });
	}
